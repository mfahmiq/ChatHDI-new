...
import { Sparkles, Code, BookOpen, Lightbulb, ArrowRight, Zap, Image, FileText, Globe, Brain, Wand2, Database, Atom, Presentation, Download, Newspaper } from 'lucide-react';
...
const WelcomeScreen = ({ onSuggestionClick, onFeatureClick }) => {
  const capabilities = [
    ...
    { icon: Newspaper, label: 'AI News', color: 'text-emerald-400', hoverBg: 'hover:bg-emerald-500/20' },
